...
$(document).ready(function() {
	...
	(function() {
		...
		$.toolbar = {
			...
			hide: function() {
				$('#buttons').prepend("<div data-toggle='tooltip' title='Show Tools Box' id='button_toolbar' class='glyphicon glyphicon-cog'></div>");
		...
		$.imagesBox = {
			...
			hide: function() {
				this.open = false;
				var button = " <div data-toggle='tooltip' title='Browse Manuscripts' id='button_images' class='glyphicon glyphicon-search'></div>";
